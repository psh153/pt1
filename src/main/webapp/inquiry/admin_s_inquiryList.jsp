...
<%}
	...
	ArrayList<InquiryDTO> inquiryList = null; // 결과 값 출력을 위한 리스트
	ArrayList<InquiryDTO> cate = null; // 드롭다운 메뉴에 현재 있는 카테고리만 보여주기 위한 리스트
...
<body>
	...
	<%for(int i = 0; i < cate.size(); i++){ 
		InquiryDTO dto = cate.get(i); // 리스트에 있는 값들 dto에 저장
		...
		<tbody>
			<%
	            ...
	            for(int i=0; i < inquiryList.size();i++){
	            	InquiryDTO inquiry = inquiryList.get(i); // 리스트에 있는 값들 dto에 저장
